                  ...
                  if (isset($_SESSION['cart'])){
                    for ($i=0,$a=1; $i < $arr_length; $i++, $a++){
                      ...
                      if(isset($_GET['editCart']) && $_GET['editCart'] == $i){
                        ...
                        echo "<td>" ;
                        echo '<input id="size-'.$i.'" required name="size-'.$i.'" step=1 type="number" value='.$_SESSION['cart'][$i]->size.' onchange="setMaxQuantity(this);">';
                        echo "</td>";
                        echo "<td>";
                        echo '<input required min=1 id="quantity-'.$i.'" name="quantity-'.$i.'" min=1 step=1 type="number" value='.$_SESSION['cart'][$i]->quantity.' onchange="getQuantity(this)">';
                        echo "</td>";
                        echo "<td>";
